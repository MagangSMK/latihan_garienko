      ...
      <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3  bg-gray-600" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-white " href="../golongan.php">
            ...
            <li class="nav-item">
              <a class="nav-link text-white " href="penggajian.php">
            ...
            <table class="min-w-full text-center">
              <thead class="border-b bg-gray-800">
                <tr>
                  ...
                  <th scope="col" class="text-sm font-medium text-white px-1 py-2">Tanggal</th> 
                  <th scope="col" class="text-sm font-medium text-white px-1 py-2">Keterangan</th> 
                  <th scope="col" class="text-sm font-medium text-white px-1 py-2">karyawan_id</th> 
                  <th scope="col" class="text-sm font-medium text-white px-1 py-2">Jumlah Gaji</th>
                  <th scope="col" class="text-sm font-medium text-white px-1 py-2">Jumlah Lembur</th>
                  <th scope="col" class="text-sm font-medium text-white px-1 py-2">Potongan</th>
                  <th scope="col" class="text-sm font-medium text-white px-1 py-2">total_gaji_diterima</th>
                  ...
                  <?php 
                    ...
                    while($user_data = mysqli_fetch_array($result5)) {
                      ...
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-blue-900'>".$id = $user_data['id']."</td>";
		                  echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$tanggal =$user_data['tanggal']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$keterangan = $user_data['keterangan']."</td>";
	    	              echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$karyawan_id = $user_data['karyawan_id']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$jumlah_gaji = $user_data['jumlah_gaji']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$jumlah_lembur = $user_data['jumlah_lembur']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$potongan = $user_data['potongan']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$total_gaji_diterima = $user_data['total_gaji_diterima']."</td>";
