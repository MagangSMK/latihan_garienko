...
<body class="g-sidenav-show" >
  <div class="bg-slate-300 py-25 px-1 min-h-screen bg-Brown">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gray-600" id="sidenav-main">
      ...
      <marquee class="bg-white" scrollamount="2"><h6 class="text-red-600" >Pengolahan Data Karyawan</h6></marquee>
      <hr class="horizontal light mt-0 mb-2">
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white " href="../public/cuti/cuti.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../public/golongan/golongan.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../public/lembur/lembur.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../public/penggajian/penggajian.php">
