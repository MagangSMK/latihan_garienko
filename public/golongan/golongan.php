              ...
              <table class="min-w-full text-center">
                <thead class="border-b bg-gray-800">
                  <tr>
                    ...
                    <th scope="col" class="text-sm font-medium text-white px-1 py-2">Nama Golongan</th> 
                    <th scope="col" class="text-sm font-medium text-white px-1 py-2">Gaji Pokok</th> 
                    <th scope="col" class="text-sm font-medium text-white px-1 py-2">Tunjangan Istri</th> 
                    <th scope="col" class="text-sm font-medium text-white px-1 py-2">Tunjangan Anak</th>
                    <th scope="col" class="text-sm font-medium text-white px-1 py-2">Tunjangan Transport</th>
                    <th scope="col" class="text-sm font-medium text-white px-1 py-2">Tunjangan Makan</th>
                  ...
                  <?php 
                    ...
                    while($user_data = mysqli_fetch_array($result2)) {
                      ...
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-blue-900'>".$id = $user_data['id']."</td>";
		                  echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$nama_golongan =$user_data['nama_golongan']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$gaji_pokok = $user_data['gaji_pokok']."</td>";
    	                echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$tunjangan_istri = $user_data['tunjangan_istri']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$tunjangan_anak = $user_data['tunjangan_anak']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$tunjangan_transport = $user_data['tunjangan_transport']."</td>";
                      echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$tunjangan_makan = $user_data['tunjangan_makan']."</td>";
